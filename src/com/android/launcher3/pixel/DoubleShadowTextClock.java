...
public class DoubleShadowTextClock extends TextClock {
    ...
    public DoubleShadowTextClock(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attributeSet, new int[] {
                R.attr.ambientShadowColor, R.attr.keyShadowColor, R.attr.ambientShadowBlur,
                R.attr.keyShadowBlur, R.attr.keyShadowOffset}, i, 0);
