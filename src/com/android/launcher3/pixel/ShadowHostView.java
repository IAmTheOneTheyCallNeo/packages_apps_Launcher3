...
public class ShadowHostView extends FrameLayout {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.mView != null && this.mView.getWidth() > 0 && this.mView.getHeight() > 0) {
            if (this.ch == null || this.ch.getHeight() != this.mView.getHeight() ||
                    this.ch.getWidth() != this.mView.getWidth()) {
                this.ch = Bitmap.createBitmap(this.mView.getWidth(),
                        this.mView.getHeight(), Bitmap.Config.ALPHA_8);
            }
    ...
    public static View getView(final RemoteViews remoteViews, final ViewGroup viewGroup,
            final View view) {
        if (remoteViews == null) {
            return null;
        }
        ...
        if (view instanceof ShadowHostView) {
            ...
            shadowHostView = (ShadowHostView) LayoutInflater.from(viewGroup.getContext()).inflate(
                    R.layout.shadow_host_view, viewGroup, false);
        }
