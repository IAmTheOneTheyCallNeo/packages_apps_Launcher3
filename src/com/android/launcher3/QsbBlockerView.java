...
import com.android.launcher3.pixel.GoogleSearchApp;
import com.android.launcher3.pixel.OnGsaListener;
import com.android.launcher3.pixel.ShadowHostView;
import com.android.launcher3.pixel.WeatherListener;
...
public class QsbBlockerView extends FrameLayout implements Workspace.OnStateChangeListener,
    ...
    protected void onAttachedToWindow() {
        ...
        GoogleSearchApp gsa = WeatherListener.aS(getContext()).getGoogleSearchAppAndAddListener(
                this);
        if (gsa != null) {
    ...
    public void onGsa(RemoteViews views) {
        ...
        if (mView == null) {
            ...
            if (oldView != null && oldState == 1) {
                ...
                inflatedView = LayoutInflater.from(getContext()).inflate(R.layout.date_widget,
                        this, false);
            }
            mView = inflatedView;
        }
        if (oldState == mState) {
            ...
            if (oldView != null) {
                oldView.animate().setDuration(n).alpha(0.0f).withEndAction(
                        new QsbBlockerViewViewRemover(this, oldView));
            }
            setPadding(0, 0, 0, 0);
            addView(mView);
            mView.setAlpha(0.0f);
